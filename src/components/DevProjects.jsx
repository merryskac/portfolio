...
const projects = [
  {
    ...
    image: import.meta.env.BASE_URL + "/img/image.png",
    ...
    screenshot: [
      import.meta.env.BASE_URL + "/img/dev/jju1.jpg",
      import.meta.env.BASE_URL + "/img/dev/jju2.jpg",
      import.meta.env.BASE_URL + "/img/dev/jju3.jpg",
      import.meta.env.BASE_URL + "/img/dev/jju4.jpg",
    ],
  },
  {
    title: "Autopause Chrome Extension",
    description: "Pause Youtube video with finger gesture using camera",
    image: import.meta.env.BASE_URL + "/img/Untitled2.png",
    tech: "ReactJs, Chrome Extension, Hand-pose Detection",
    github_url: "https://github.com/merryskac/autopauseExtension",
    screenshot: [
      import.meta.env.BASE_URL + "/img/dev/3.png",
      import.meta.env.BASE_URL + "/img/dev/4.png",
    ],
  },
  {
    title: "Safe Trip",
    description: "Let someone track your trip location in real-time",
    image: import.meta.env.BASE_URL + "/img/safetrip.jpg",
    tech: "ReactJs, ExpressJs, socket.io, mongodb, leaflet",
    github_url: "https://github.com/merryskac/safeTripFE",
    screenshot: [
      import.meta.env.BASE_URL + "/img/safetrip3.jpg",
      import.meta.env.BASE_URL + "/img/safetrip4.jpg",
      import.meta.env.BASE_URL + "/img/safetrip5.jpg",
    ],
  },
];
